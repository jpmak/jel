...
<head>
    ...
    <title>娇尔乐,一个知道如何做好含有茶多酚元素卫生巾的品牌</title>
    <meta name="keywords" content="娇尔乐,一个知道如何做好含有茶多酚元素卫生巾的品牌">
    <meta name="description" content="娇尔乐,一个知道如何做好含有茶多酚元素卫生巾的品牌">
    ...
    <!-- <script src=' http://www.xqtybj.me/wp-content/themes/tybj/dist/js/loadjs.js'></script> -->

    <script src='<?=jel_of?>common/js/loadjs.js'></script>
</head>
<body class="loaded">
<div class="site">
            ...
            <main class="site-main-1">
                ...
                <li></li>
                    ...
                    <div class="video_play">
                        <video id="video" autoplay loop muted="muted" poster="<?=jel_img?>dist/images/video_img.jpg" webkit-playsinline />
                        </video>
                    </div>
                    <div class="container">
                        <div class="row row-table">
                            <div class="col-sm-12">
                                <div class="col-inner op0" data-scroll-reveal="enter bottom over 1.5s " >
                                    <div class="section-heading ">
                                        <img id="img" class="v-banner hidden-xs mt-50" src="<?=jel_img?>dist/images/wenzi.png" >
                                           <img class="v-banner visible-xs mt_20" src="<?=jel_img?>dist/images/h-wenzi.png" >
                                    </div>
                                    <!-- .section-heading -->
                                </div>
                            </div>
                                        ...
                                        <div class="grid">
                                            <div class="figure">
                                                <figure class="effect-apollo">
                                                    <img class="lazy" src="<?=jel_img?>dist/images/loading.jpg" data-original="<?=jel_img?>dist/images/j_01.jpg" alt="img18">
                                                    <figcaption>
                                                        <h2>礼盒装</h2>
                                ...
                                <div class="hor-view site-of">
                                    <a href="" >
                                        <div class="grid">
                                            <div class="figure">
                                                <figure class="effect-apollo">
                                                    <img class="lazy" src="<?=jel_img?>dist/images/loading.jpg" data-original="<?=jel_img?>dist/images/j_02.jpg" alt="img18">
                                                    <figcaption>
                                                        <h2>超长夜用 <span>400mm</span></h2>
                                ...
                                <div class="hor-view site-of">
                                    <a href="" >
                                        <div class="grid">
                                            <div class="figure">
                                                <figure class="effect-apollo">
                                                    <img class="lazy" src="<?=jel_img?>dist/images/loading.jpg" data-original="<?=jel_img?>dist/images/j_03.jpg" alt="img18">
                                                    <figcaption>
                                                        <h2>夜用 <span>290mm</span></h2>
                                ...
                                <div class="hor-view site-of">
                                    <a href="" >
                                        <div class="grid">
                                            <div class="figure">
                                                <figure class="effect-apollo">
                                                    <img class="lazy" src="<?=jel_img?>dist/images/loading.jpg" data-original="<?=jel_img?>dist/images/j_04.jpg" alt="img18">
                                                    <figcaption>
                                                        <h2>日用 <span>245mm</span></h2>
                                ...
                                <div class="hor-view site-of">
                                    <a href="" >
                                        <div class="grid">
                                            <div class="figure">
                                                <figure class="effect-apollo">
                                                    <img class="lazy" src="<?=jel_img?>dist/images/loading.jpg" data-original="<?=jel_img?>dist/images/j_05.jpg" alt="img18">
                                                    <figcaption>
                                                        <h2>迷你 <span>180mm</span></h2>
                                ...
                                <div class="hor-view site-of">
                                    <a href="" >
                                        <div class="grid">
                                            <div class="figure">
                                                <figure class="effect-apollo">
                                                    <img class="lazy" src="<?=jel_img?>dist/images/loading.jpg" data-original="<?=jel_img?>dist/images/j_06.jpg" alt="img18">
                                                    <figcaption>
                                                        <h2>护垫 <span>155mm</span></h2>
                                    ...
                                    <div class="swiper-container swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                   <a>
                                                <img class="swiper-lazy" data-src="<?=jel_img?>dist/images/w-1.jpg">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                            <a >
                                                <img class="swiper-lazy" data-src="<?=jel_img?>dist/images/w-2.jpg">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Add Pagination -->
              ...
              <?php $category = get_the_category();//定义分类目录?>              
                <li class="col-xs-12 col-sm-6 col-md-4 op0" data-scroll-reveal="enter top over 1s ">
                    <a href="<?php the_permalink(); ?>">
                        <div class="goods-pic">
                            <figure><img class="lazy" src="<?=jel_img?>dist/images/loadbg.jpg"  data-original="<?php bloginfo('template_url');?>/timthumb.php?src=<?php echo post_thumbnail_src(); ?>&h=238&w=238&zc=1""></figure>
                        </div>
                        <h3><?php the_title(); ?></h3>
                    </a>
                </li>
